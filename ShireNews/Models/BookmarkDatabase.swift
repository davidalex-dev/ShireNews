// Database for saved Bookmarks
// Saved bookmarks can be found here

import Foundation

protocol BookmarkDatabase: Actor{
...
actor PlistDataStore<T: Codable>: BookmarkDatabase where T: Equatable{
